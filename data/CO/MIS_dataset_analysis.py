...
with open("test/MIS_test.pkl", 'rb') as f:
    dataset = pickle.load(f)
    graphs_list = [data[0] for data in dataset]
    labels_list = [data[1] for data in dataset]
    MIS_graphs.append(graphs_list)
    MIS_labels.append(labels_list)

with open("test/MIS_30_0.6_test.pkl", 'rb') as f:
    dataset = pickle.load(f)
    graphs_list = [data[0] for data in dataset]
    labels_list = [data[1] for data in dataset]
    MIS_graphs.append(graphs_list)
...
with open("test/MIS_90_0.2_test.pkl", 'rb') as f:
    dataset = pickle.load(f)
    graphs_list = [data[0] for data in dataset]
    labels_list = [data[1] for data in dataset]
    MIS_graphs.append(graphs_list)
...
with open("test/MIS_90_0.6_test.pkl", 'rb') as f:
    dataset = pickle.load(f)
    graphs_list = [data[0] for data in dataset]
    labels_list = [data[1] for data in dataset]
    MIS_graphs.append(graphs_list)
...
with open("test/MIS_180_0.5_test.pkl", 'rb') as f:
    dataset = pickle.load(f)
    graphs_list = [data[0] for data in dataset]
    labels_list = [data[1] for data in dataset]
    MIS_graphs.append(graphs_list)
...
all_average_objs = analyze_labels_list(MIS_labels)
print('[average opt value, std dev, average num of opt sols, std]')
print(all_average_objs)

# Analyze the dataset
all_densities, all_degrees = analyze_graphs_list(MIS_graphs)
...
plt.xlabel('Dataset')
plt.ylabel('Density')
plt.title('Densities for Each Test Dataset (MIS)')
plt.show()
...
plt.xlabel('Dataset')
plt.ylabel('Degree')
plt.title('Degrees for Each Test Dataset (MIS)')
plt.show()
