...
def train(config_path):
    ...
    # load dataset
    train_dataset = LoadData(data_dir='data/CO/train', name=dataset_name, split='train', features=features, labels="one")
    val_dataset = LoadData(data_dir='data/CO/val', name=dataset_name, split='val', features=features, labels="one")
...
def main():
    ...
    # TESTING
    config_path = 'configs/MC/base/test/one/MC_EGT_100k_test_30_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GAT_100k_test_30_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GatedGCN_100k_test_30_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GCN_100k_test_30_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GIN_100k_test_30_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GMM_100k_test_30_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GraphSage_100k_test_30_0.6_one.json'
    #test(config_path=config_path)

    config_path = 'configs/MC/base/test/one/MC_EGT_100k_test_90_0.2_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GAT_100k_test_90_0.2_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GatedGCN_100k_test_90_0.2_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GCN_100k_test_90_0.2_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GIN_100k_test_90_0.2_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GMM_100k_test_90_0.2_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GraphSage_100k_test_90_0.2_one.json'
    #test(config_path=config_path)

    config_path = 'configs/MC/base/test/one/MC_EGT_100k_test_90_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GAT_100k_test_90_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GatedGCN_100k_test_90_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GCN_100k_test_90_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GIN_100k_test_90_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GMM_100k_test_90_0.6_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GraphSage_100k_test_90_0.6_one.json'
    #test(config_path=config_path)

    config_path = 'configs/MC/base/test/one/MC_EGT_100k_test_180_0.5_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GAT_100k_test_180_0.5_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GatedGCN_100k_test_180_0.5_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GCN_100k_test_180_0.5_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GIN_100k_test_180_0.5_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GMM_100k_test_180_0.5_one.json'
    #test(config_path=config_path)
    config_path = 'configs/MC/base/test/one/MC_GraphSage_100k_test_180_0.5_one.json'
    #test(config_path=config_path)
